...
import com.example.xiaoyouxi.databinding.FragmentLoseBinding;
...
public class LoseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_lose, container, false);
        ...
        binding.setLost(myViewModel);
        binding.setLifecycleOwner(getActivity());
        binding.button15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavController controller = Navigation.findNavController(v);
                controller.navigate(R.id.action_loseFragment_to_startFragment);
                myViewModel.getScoreNumber().setValue(0);
            }
        });
